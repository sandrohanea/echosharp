...
public class WhisperOnnxSpeechProcessorConfig
{
    /// <summary>
    /// The path where the model file will be downloaded and used for speech processing.
    /// </summary>
    /// <remarks>
    /// If this is set, the model file will be downloaded and used for speech processing.
    /// If this is not set, the model will be downloaded in memory and used for speech processing (not persisted to disk).
