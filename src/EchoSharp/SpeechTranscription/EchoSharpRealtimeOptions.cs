...
public class EchoSharpRealtimeOptions
{
    /// <summary>
    /// Represents the length of the padding segmetents that will be appended to each sement detected by the VAD.
    /// </summary>
    /// <example>
    /// If the VAD detects a segment of 1200ms starting at offset 200ms, and the <see cref="PaddingDuration"/> is 125ms, 125ms of the original stream will be appended at the beginning and 125ms at the end of the segment.
    /// </example>
    /// <remarks>
    ...
    /// <summary>
    /// Represents the minimum length of a segment that will be processed by the transcriptor, if the segment is shorter than this value it will be ignored.
    /// </summary>
    ...
    /// </summary>
    /// <example>
    /// If the segment is 700ms, and the <see cref="MinDurationWithPadding"/> is 1100ms, the segment will be padded with 400ms of silence (200 ms at the beginning and 200ms at the end).
    /// </example>
