...
public interface IRealtimeSpeechTranscriptorProvisioner
{
    /// <summary>
    ...
    public Task<IRealtimeSpeechTranscriptorFactory> ProvisionAsync(CancellationToken cancellationToken = default);
}
