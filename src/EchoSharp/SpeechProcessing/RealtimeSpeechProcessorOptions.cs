...
public record RealtimeSpeechProcessorOptions : SpeechProcessorOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to autodetect the language only once at startup and use it for all the segments, instead of autodetecting it for each segment.
    /// </summary>
