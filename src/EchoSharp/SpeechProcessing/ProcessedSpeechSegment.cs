...
/// <summary>
/// Represents a segment of the text processed by a <see cref="ISpeechProcessor"/>.
/// </summary>
public class ProcessedSpeechSegment
{
    /// <summary>
    ...
    /// </remarks>
    public IList<ProcessedSpeechToken>? Tokens { get; set; }
}
